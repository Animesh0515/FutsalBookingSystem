    ...
    <div class="container d-flex justify-content-center align-items-center"
      style="padding-top:6rem;">
      	<form class="border shadow p-3 rounded"
      	      action="controls/Registerfutsal.php" 
      	      method="post" 
        ...
        <div class="row" >
          ...
          <div class="mb-3">
		    <label for="description" 
		           class="form-label" style="width: 18rem;">Description<em>(Must be less than 500 words)</em></label><br/>
...
<em style="color:red;">**Please Note that the futsal registered needs to be approved by admin first**</em><br/>
		  <button type="submit" 
